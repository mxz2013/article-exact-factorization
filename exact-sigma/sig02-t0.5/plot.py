...
plt.ylabel('Im$\Sigma_{02}$ ', fontdict=font)
...
plt.title('$t=0.5$',fontdict=font)
plt.ylabel('Re$\Sigma_{02}$ ', fontdict=font)
...
#plt.tight_layout()
plt.savefig('sig02-t0.5.eps', format='eps', dpi=1000)
plt.savefig('sig02-t0.5.pdf', format='pdf')
#
plt.show()
